...
В основном, я имею мало опыта, что рассуждать о списках OVAL, но например, в третьем патче (**Ruby**) есть 5 разных CVE, но все они касаются одного компонента и исправляются одним обновлением. Их можно было бы сгруппировать связанные уязвимости или сослаться на основную тему. 
