...
| **Необходимые привилегии**      | Не требуется | Не требуется |
| **Взаимодействие с пользователем** | Не требуется | Не требуется |
| **Область действия (Scope)**    | Без изменений | Без изменений |
| **Воздействие на конфиденциальность** | Отсутствует | Отсутствует |
| **Воздействие на целостность**       | Высокое | Высокое |
| **Воздействие на доступность**       | Высокое | Высокое |
